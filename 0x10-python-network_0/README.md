...
with this networking project, you will `curl` in Bash scripts to send various types
of HTTP headers. In the process, you will learned about how URL's work, domain names,
...
NOTE: The `curl` behavior in all Bash scripts were written to communicate with a
