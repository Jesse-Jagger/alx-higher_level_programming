...
--
-- a script that will use the hbtn_0d_tvshows database to lists all genres not linked to Dexter
-- tv_shows table contains only one record where title like Dexter (but the id can be different)
