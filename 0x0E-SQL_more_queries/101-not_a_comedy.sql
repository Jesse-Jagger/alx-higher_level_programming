...
--
-- A script that will lists all non-Comedy shows in the database hbtn_0d_tvshows
-- tv_genres table contains only one record where name like Comedy (but the id can be different)
